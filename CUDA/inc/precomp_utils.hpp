...
/** \brief Compute Sector Mapping for one coordinate based on the current grid dimension and sector width 
  *
  * This way is neccessary in order to support grid dimensions which are not integer multiples of 
...
/** \brief Compute Sector Mapping with the same resolution as in resolutionSectorCount
