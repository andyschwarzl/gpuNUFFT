...
gpuNUFFT::Array<IndType> gpuNUFFT::GpuNUFFTOperatorMatlabFactory::initDataIndices(gpuNUFFT::GpuNUFFTOperator* gpuNUFFTOp, IndType coordCnt)
{	
	if (MATLAB_DEBUG)
...
gpuNUFFT::Array<DType> gpuNUFFT::GpuNUFFTOperatorMatlabFactory::initCoordsData(gpuNUFFT::GpuNUFFTOperator* gpuNUFFTOp, IndType coordCnt)
{	
	if (MATLAB_DEBUG)
...
gpuNUFFT::Array<IndType> gpuNUFFT::GpuNUFFTOperatorMatlabFactory::initSectorCenters(gpuNUFFT::GpuNUFFTOperator* gpuNUFFTOp, IndType sectorCnt)
{
	if (MATLAB_DEBUG)
		mexPrintf("init Sector Centers Output Array: %d\n",sectorCnt);
	plhs[4] = createSectorCentersArray(sectorCnt,gpuNUFFTOp->getImageDimensionCount());
...
gpuNUFFT::Array<IndType> gpuNUFFT::GpuNUFFTOperatorMatlabFactory::initSectorDataCount(gpuNUFFT::GpuNUFFTOperator* gpuNUFFTOp, IndType dataCount)
{
	if (MATLAB_DEBUG)
...
gpuNUFFT::Array<IndType2> gpuNUFFT::GpuNUFFTOperatorMatlabFactory::initSectorProcessingOrder(gpuNUFFT::GpuNUFFTOperator* gpuNUFFTOp, IndType sectorCnt)
{
  if (MATLAB_DEBUG)
...
gpuNUFFT::Array<DType> gpuNUFFT::GpuNUFFTOperatorMatlabFactory::initDensData(gpuNUFFT::GpuNUFFTOperator* gpuNUFFTOp, IndType coordCnt)
{
	if (MATLAB_DEBUG)
...
gpuNUFFT::GpuNUFFTOperator* gpuNUFFT::GpuNUFFTOperatorMatlabFactory::createGpuNUFFTOperator(gpuNUFFT::Array<DType>& kSpaceTraj, Array<DType>& densCompData, Array<DType2>& sensData, const IndType& kernelWidth, const IndType& sectorWidth, const DType& osf, gpuNUFFT::Dimensions& imgDims,mxArray *plhs[])
{
	if (MATLAB_DEBUG)
	...
	GpuNUFFTOperator* gpuNUFFTOp = GpuNUFFTOperatorFactory::createGpuNUFFTOperator(kSpaceTraj,densCompData,sensData,kernelWidth,sectorWidth,osf,imgDims);
